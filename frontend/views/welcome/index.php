	...
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="<?php echo $logo['base_url'].$logo['url'].$logo['path']  ?>" class="userAvatar"></a>
				<p>你好！<span class="userName"><?php echo $userName ?></span>, 欢迎登录</p>
			</div>
			<!-- 搜索 -->
			...
			<div class="navBar layui-side-scroll" id="navBar">
				<ul class="layui-nav layui-nav-tree">
					<li class="layui-nav-item layui-this">
						<a href="javascript:;" data-url="welcome/main"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
					</li>
				</ul>
			</div>
		</div>
			...
			<div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
				...
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						<iframe src="welcome/main"></iframe>
					</div>
				</div>
			</div>
		</div>
