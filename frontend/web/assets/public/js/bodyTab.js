        ...
        var ulHtml = '';
         for (var i in  data){
             ...
             if(data[i].children != undefined){
                 ...
                 for (var c in  data[i].children){
                     ulHtml += '<dd><a data-url="'+data[i].children[c].route+'">';
                     if(data[i].children[c].icon != undefined && data[i].children[c].icon != ''){
                         ulHtml += '<i class="layui-icon" data-icon="'+data[i].children[c].icon+'">'+data[i].children[c].icon+'</i>';
					 }
                     ulHtml += '<cite>'+data[i].children[c].name+'</cite></a></dd>';
				 }
                 ulHtml += "</dl>";
             }else{
